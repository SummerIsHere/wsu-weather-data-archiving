...
### Main function to run the entire chain of downloading and extracting data for Puget Sound stations only
###
###
...
sl_file = os.path.join(wsu_folder, 'puget_sound_station_list.csv')
si_file = os.path.join(wsu_folder, 'puget_sound_station_info.csv')
...
logging.info('End run_puget_sound.py')
